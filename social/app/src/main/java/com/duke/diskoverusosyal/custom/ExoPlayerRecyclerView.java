package com.duke.diskoverusosyal.custom;
...
public class ExoPlayerRecyclerView extends RecyclerView {
   ...
   */
  private ImageView mediaCoverImage, volumeControl,ivPlayVideo;
   ...
   */
  // Media List
  private ArrayList<DataItem> mediaObjects = new ArrayList<>();
  ...
  private void init(Context context) {
    ...
    videoPlayer = ExoPlayerFactory.newSimpleInstance(renderersFactory, trackSelector,loadControl);
  ...
  public void playVideo(boolean isEndOfList) {
    ...
    RecyclerView_Home_Adapter.PlayerViewHolder holder = (RecyclerView_Home_Adapter.PlayerViewHolder) child.getTag();
    if (holder == null) {
      playPosition = -1;
      return;
    }
      viewHolderParent = holder.getParent();
      ivPlayVideo = holder.getIvPlayVideo();
    if(holder.getItemViewType()==2) {
      mediaCoverImage = holder.getMediaCoverImage();
      progressBar = holder.getProgressBar();
      volumeControl = holder.getVolumeControl();
      requestManager = holder.getRequestManager();
      mediaContainer = holder.getMediaContainer();
      videoSurfaceView.setPlayer(videoPlayer);
      ...
      requestManager.load(R.drawable.ic_unmute).into(volumeControl);
    }
    else{
        onPausePlayerWhenImageView();
    }
  ...
  public void onPausePlayerWhenImageView() {
    if (videoPlayer != null) {
  ...
  public void onResumePlayer(int currentPosition) {
    if (videoPlayer != null) {
...
//          .setDuration(600).setStartDelay(1000);
  ...
  public void setMediaObjects(ArrayList<DataItem> mediaObjects) {
